      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-16">
          <h1 className="text-blush text-4xl md:text-5xl font-light mb-4">
            Client <span className="italic font-serif">Portal</span>
          </h1>
          <p className="font-sans text-[10px] tracking-[0.2em] uppercase text-blush/50">
            Sign in to view your bookings & quotations
          </p>
        </div>

        <form className="space-y-8" onSubmit={handleSubmit}>
          <div className="border-b border-blush/20">
            <label className="font-sans text-[9px] tracking-[0.3em] uppercase text-blush/40 block mb-2 text-center">Email Address</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div className="border-b border-blush/20">
            <label className="font-sans text-[9px] tracking-[0.3em] uppercase text-blush/40 block mb-2 text-center">Password</label>
            <input
              type="password"
              required
              value={password}
        ...
        <div className="mt-12 text-center space-y-4">
          <p className="font-sans text-[10px] tracking-[0.1em] uppercase text-blush/40">
            New client?{' '}
            <Link to="/client/register" className="text-rose hover:text-blush transition-colors border-b border-rose/30 pb-0.5">
              Create an account
            </Link>
          </p>
          <Link to="/admin/login" className="block font-sans text-[9px] tracking-[0.2em] uppercase text-blush/20 hover:text-blush/40 transition-colors">
            Admin login →
          </Link>
        </div>
      </div>
